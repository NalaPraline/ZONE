...
public class DatabaseService : IDisposable
{
    ...
    public void SeedActivitiesIfEmpty()
    {
        ...
        AddActivity(new Activity { Name = "Poker",              Description = "Texas Hold'em. Think you can take the pot?",                        PotAmount = "BOOSTED POT  100,000,000 Gil", Host = "Enzo Valentine",           Day = 1, StartTime = "19:30 - 01:00",          Details = "To enter, message enzoxiv on Discord at least 1 hour before start (19:30 ST).\n\nRULESET\nTexas Hold'em\nMax 30 spots across 3 full tables (first come, first served).\nBlinds increase every 20 minutes of live play. No antes.\n\nPRIZES\n1st Place: 65% of overall pot\n2nd Place: 25% of overall pot\n3rd Place: 10% of overall pot\n\nPOT\n100,000,000 Gil boosted\n2,500,000 Gil buy-in" });
