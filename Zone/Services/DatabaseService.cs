...
public class DatabaseService : IDisposable
{
    ...
    public void SeedActivitiesIfEmpty()
    {
        ...
        AddActivity(new Activity { Name = "Blackjack",          Description = "Hit or stand. No in-between.",                                      Host = "TBD",                              Day = 1, StartTime = "18:00 - 00:00", LocationName = "Project XIV",     MapZone = "BLACKJACK", PartnerId = 3,  Details = "Hit or stand. No in-between.\nMake the call and pull a queen.\n\nHOW TO PLAY\nBeat the dealer without going over 21.\nFace cards are worth 10. Aces count as 1 or 11.\nHit to draw another card. Stand to hold your hand.\nGo over 21 and you bust.\n\nNOTE\nRules may vary depending on the dealer." });
        AddActivity(new Activity { Name = "Scratch Cards",      Description = "Scratch your luck.",                                                Host = "Nala Praline",                     Day = 1, StartTime = "18:00 - 01:00", LocationName = "Nocturn",         PartnerId = 4 });
        AddActivity(new Activity { Name = "Poker",              Description = "Texas Hold'em. Think you can take the pot?",                        PotAmount = "BOOSTED POT  100,000,000 Gil", Host = "Enzo Valentine",           Day = 1, StartTime = "19:30",          Details = "To enter, message enzoxiv on Discord at least 1 hour before start (19:30 ST).\n\nRULESET\nTexas Hold'em\nMax 30 spots across 3 full tables (first come, first served).\nBlinds increase every 20 minutes of live play. No antes.\n\nPRIZES\n1st Place: 65% of overall pot\n2nd Place: 25% of overall pot\n3rd Place: 10% of overall pot\n\nPOT\n100,000,000 Gil boosted\n2,500,000 Gil buy-in" });
        ...
        AddActivity(new Activity { Name = "Blackjack",          Description = "Hit, stand, and double-down.",                                      Host = "TBD",                              Day = 2, StartTime = "18:00 - 00:00", LocationName = "Phoenix Nights",  MapZone = "BLACKJACK", PartnerId = 5,  Details = "Hit, stand, and double-down.\nMake the call, retrieve your crown.\n\nHOW TO PLAY\nBeat the dealer without going over 21.\nFace cards are worth 10. Aces count as 1 or 11.\nHit to draw another card. Stand to hold your hand.\nGo over 21 and you bust.\n\nNOTE\nRules may vary depending on the dealer." });
        AddActivity(new Activity { Name = "Scratch Cards",      Description = "Scratch your luck.",                                                Host = "Ellie Gator, Nala Praline",        Day = 2, StartTime = "18:00 - 01:00", LocationName = "PNX & Nocturn",   PartnerId = 5 });
        AddActivity(new Activity { Name = "Deathroll Tournament", Description = "First to hit 1 is out. Last one standing wins.",                  Host = "Rin Tsukii",                       Day = 2, StartTime = "21:00",          LocationName = "Ignite",          PartnerId = 16, Details = "PRIZES\n1st Place: Dais of Darkness\n2nd Place: Genie of the Lamp\n\nMAX SPOTS\n32 players\n\nHOW TO ENTER\nSign up on the Ignite Discord between 18:00 - 21:00 ST.\nBe present at the designated place at 21:00 ST.\n\nRULES\nSingle-elimination format.\nEach duel starts with /dice 500.\nFirst player to hit 1 loses.\nTurns are announced in-game." });
    }
