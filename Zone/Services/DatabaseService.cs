...
public class DatabaseService : IDisposable
{
    ...
    public void SeedActivitiesIfEmpty()
    {
        ...
        AddActivity(new Activity { Name = "Second Bingo",       Description = "There at bay, in the gold den.",                                   PotAmount = "BOOSTED POT 50,000,000 Gil", Host = "Renna Hina", Day = 2, StartTime = "21:00 - 23:00", LocationName = "Project XIV",   MapZone = "GAMES",     PartnerId = 3,  Details = "There at bay, in the gold den.\nMine to claim, the prize golden.\n\nPOT\n50,000,000 Gil\n\nTICKETS\nUp to 12 tickets per game\n200,000 Gil per ticket" });
