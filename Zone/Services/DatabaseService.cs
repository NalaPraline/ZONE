...
public class DatabaseService : IDisposable
{
    ...
    public void SeedActivitiesIfEmpty()
    {
        ...
        AddActivity(new Activity { Name = "Blackjack",          Description = "Hit or stand. No in-between.",                                      Host = "Lindhard Forester, Kisara Tendo, Sakuya Haibara",  Day = 1, StartTime = "18:00 - 00:00", LocationName = "Project XIV",     MapZone = "BLACKJACK", PartnerId = 3,  Details = "Hit or stand. No in-between.\nMake the call and pull a queen.\n\nHOW TO PLAY\nBeat the dealer without going over 21.\nFace cards are worth 10. Aces count as 1 or 11.\nHit to draw another card. Stand to hold your hand.\nGo over 21 and you bust.\n\nNOTE\nRules may vary depending on the dealer." });
        AddActivity(new Activity { Name = "Poker",              Description = "Texas Hold'em. Think you can take the pot?",                        PotAmount = "BOOSTED POT 300,000,000 Gil", Host = "Enzo Valentine",           Day = 1, StartTime = "19:30 - 01:00",          PartnerId = 3, ContactUrl = "https://discordid.netlify.app/?id=1287676375133720596", Details = "To enter, message enzoxiv on Discord at least 1 hour before start (19:30 ST).\n\nRULESET\nTexas Hold'em\nMax 30 spots across 3 full tables (first come, first served).\nBlinds increase every 20 minutes of live play. No antes.\n\nPRIZES\n1st Place: 65% of overall pot\n2nd Place: 25% of overall pot\n3rd Place: 10% of overall pot\n\nPOT\n300,000,000 Gil boosted\n2,500,000 Gil buy-in" });
        ...
        AddActivity(new Activity { Name = "Glam Contest",      Description = "Urban/Industrial Chic meets Rave Nightlife. Best glam wins 50M Gil.",  PotAmount = "PRIZE POOL 50,000,000 Gil", Host = "Rey Alex", Day = 1, StartTime = "17:00 - 01:00", LocationName = "Urban", PartnerId = 2, ContactUrl = "https://discord.com/invite/urbanclub", Details = "PRIZE POOL\n50,000,000 Gil\n\nTHEME\nUrban/Industrial Chic meets Rave Nightlife.\nRed / White / Black\n\nHOW TO ENTER\nPost your picture in Urban Discord's Contest channel under \"Activities\".\nContest runs March 27-28. Winners announced March 29.\n\nRULES\nTake your own screenshot and post it in the contest channel.\nNeed help? Reach out to a photographer.\nWeapons, emotes, accessories, minions, and skills are allowed.\nMods are allowed.\nScreenshots must be taken in the event area.\nZONE merch glam does not count." });

        // Saturday
        AddActivity(new Activity { Name = "First Bingo",        Description = "Did someone yell bingo or was it your imagination?",               PotAmount = "BOOSTED POT 50,000,000 Gil", Host = "Bean Buns",                Day = 2, StartTime = "18:00 - 20:00", LocationName = "Phoenix Nights",  MapZone = "GAMES",     PartnerId = 5,  Details = "Did someone yell bingo or was it your imagination?\nYou cannot tell in your winning wishes affliction.\n\nPOT\n50,000,000 Gil\n\nTICKETS\nUp to 12 tickets per game\n200,000 Gil per ticket" });
        AddActivity(new Activity { Name = "Second Bingo",       Description = "There at bay, in the gold den.",                                   PotAmount = "BOOSTED POT 50,000,000 Gil", Host = "Reika Maye, Astrin Maye, Renna Hina, Bunji Tsukiyama", Day = 2, StartTime = "21:00 - 23:00", LocationName = "Project XIV",   MapZone = "GAMES",     PartnerId = 3,  Details = "There at bay, in the gold den.\nMine to claim, the prize golden.\n\nPOT\n50,000,000 Gil\n\nTICKETS\nUp to 12 tickets per game\n200,000 Gil per ticket" });
        ...
        AddActivity(new Activity { Name = "Glam Contest",      Description = "Urban/Industrial Chic meets Rave Nightlife. Best glam wins 50M Gil.",  PotAmount = "PRIZE POOL 50,000,000 Gil", Host = "Rey Alex", Day = 2, StartTime = "17:00 - 01:00", LocationName = "Urban", PartnerId = 2, ContactUrl = "https://discord.com/invite/urbanclub", Details = "PRIZE POOL\n50,000,000 Gil\n\nTHEME\nUrban/Industrial Chic meets Rave Nightlife.\nRed / White / Black\n\nHOW TO ENTER\nPost your picture in Urban Discord's Contest channel under \"Activities\".\nContest runs March 27-28. Winners announced March 29.\n\nRULES\nTake your own screenshot and post it in the contest channel.\nNeed help? Reach out to a photographer.\nWeapons, emotes, accessories, minions, and skills are allowed.\nMods are allowed.\nScreenshots must be taken in the event area.\nZONE merch glam does not count." });
    ...
    public void SeedPartnersIfEmpty(string partnerDir)
    {
        ...
        var partners = new (string name, string logo, string discord)[]
        {
            ...
            ("Eclipse Horizon",          "Eclipse Horizon.png",          "https://discord.com/invite/jCDqkUv93K"),
            ("Untamed",                  "Untamed.png",                   "https://discord.gg/cUsuQ3zBB"),
        };
